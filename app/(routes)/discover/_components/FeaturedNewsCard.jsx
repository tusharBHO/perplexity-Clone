...
function FeaturedNewsCard({ news }) {
    ...
    return (
        <div
            className="flex flex-col-reverse sm:flex-row rounded-2xl cursor-pointer overflow-hidden transition border border-theme md:border-none bg-secondary sm:bg-primary"
        ...
        >
            ...
            {news?.thumbnail?.original ? (
                <div className="sm:w-1/2 h-72 sm:h-68 md:h-72 rounded-2xl overflow-hidden">
                    <img
...
//     return (
//         <div
//             className="flex flex-col md:flex-row rounded-2xl cursor-pointer overflow-hidden transition border border-theme sm:border-none"
//             onClick={() => window.open(news?.url, '_blank')}
//         >
//             {/* Left side: text */}
//             <div className="p-6 flex-1 flex flex-col justify-center">
